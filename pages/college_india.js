...
function Colleges() {
    ...
    const fetchData = async () => {
        ...
        const res = await fetch(`http://127.0.0.1:8000/get_colleges?query=INDIA`, {
            method: "GET",
        });
    ...
    return (
        <>
            <Navbar />
            <section >
                <div className=" w-full my-10 rounded-xl  px-50" ><p className="text-blue-950 text-8xl text-center font-bold"> Universities of INDIA</p></div>
