...
import Comparision from "@/components/Comparision_tab";
...
export default function Compare() {
    ...
    return (
        <>
            <Navbar />
            <section className=" bg-blue-950 text-center text-white">
                ...
                <div>
                        ...
                        <div className="gap-2">
                            ...
                            <div className="py-3">
                                <select id="college2" onChange={handleCollege2Change} className=" college-input text-blue-950 h-10 px-5 rounded-lg ">
                                    <option value="">Select a college</option>
                                    {colleges.map((college) => (
                                        <option className="text-cyan" key={college.id} value={college.name}>
                                            {college.name}
                                        </option>
                                    ))}
                                </select></div>
                    ...
                    <div className="flex flex-row justify-center items-center mt-8">
                        <button className="bg-cyan hover:bg-white hover:text-cyan border-cyan border-2 text-white font-bold py-2 px-4 rounded mr-4" onClick={handleCompareClick}>
                            Compare
                        </button>
                        <button className="bg-cyan hover:bg-white hover:text-cyan border-cyan border-2 text-white font-bold py-2 px-4 rounded mr-4" onClick={handleResetClick}>
                            Reset
                        </button>
                    </div>
                </div>
